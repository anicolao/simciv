...
## Development Pathways for Military, Cultural, and Economic Victory

### Document Status
**Version:** 0.0018  
**Status:** Design Review  
**Last Updated:** 2025-10-30  
**Purpose:** Specification for civilization progression trees that enable distinct paths to victory through Military Domination, Cultural Influence, and Economic Supremacy, with Scientific Victory achieved through the unified Technology Tree

---

## Executive Summary

This document defines the progression tree system for SimCiv's victory conditions. The game features a unified **Technology Tree** (covering all fundamental discoveries from fire to quantum physics) and three **application-focused progression trees** (Military, Cultural, Economic) that determine how civilizations apply their technological knowledge toward different victory conditions.

**Key Insight:**
- **Technology Tree** (unified, see 0.0004_TECH_TREE.md): ALL civilizations progress through the same tree of fundamental discoveries
- **Progression Trees** (this document): How civilizations APPLY those discoveries - military doctrine, cultural expression, economic systems

**Key Features:**
- Three distinct progression trees (Military, Cultural, Economic) focusing on application and specialization
- Scientific Victory achieved through advancing the unified Technology Tree to breakthrough discoveries
- Strategic specialization within each tree (e.g., naval vs. land military doctrine, religion vs. arts cultural focus)
- Interconnected dependencies requiring both technological advancement and strategic application
- Clear progression paths from early game to victory conditions
- Diplomatic victory as a player-driven consensus mechanism

**Victory Paths:**
- **Domination**: Military Tree + supporting technologies → territorial conquest
- **Scientific**: Technology Tree advancement → Mars colonization or AI singularity
- **Cultural**: Cultural Tree + supporting technologies → overwhelming influence
- **Economic**: Economic Tree + supporting technologies → resource dominance
- **Diplomatic**: Player consensus based on diplomatic behavior

This design separates what civilizations discover (Technology Tree) from how they apply that knowledge (Progression Trees), creating strategic depth through meaningful choices about civilization development.

---

## Related Documents

- **0.0004_TECH_TREE.md**: Unified Technology Tree (prehistoric era, to be extended through all eras) - covers ALL fundamental discoveries including what was previously called "scientific" advancement
...
**Important Note**: The Technology Tree documented in 0.0004_TECH_TREE.md currently covers only the prehistoric era but is intended to extend through all historical eras (Ancient, Classical, Medieval, Renaissance, Industrial, Modern, Future). Scientific Victory is achieved by advancing far enough on this unified Technology Tree to reach breakthrough discoveries like Mars colonization or AI consciousness. There is no separate "Science Tree" - all civilizations share the same Technology Tree.

---

## Architecture Context

The progression tree system integrates with SimCiv's technology and game systems:

- **Unified Technology Tree**: All civilizations progress through the same tree of discoveries (Fire → Metallurgy → Printing → Electricity → Quantum Physics, etc.). This provides the capabilities that progression trees apply.
- **Progression Trees (this document)**: Civilization-specific choices about how to apply technological capabilities - military doctrine, cultural focus, economic systems
- **Database Layer**: Stores both technology progress (shared) and progression tree choices (civilization-specific)
- **Simulation Engine**: Uses both tech status and progression choices to determine available actions, unit types, building capabilities
- **Resource System**: Technologies unlock resources; progression trees determine how resources are utilized
- **Victory Detection**: Tracks both technology advancement (Scientific Victory) and progression tree achievements (other victories)

**Key Architectural Principle**: Technologies are discoveries available to all; progressions are strategic choices unique to each civilization.

---

## Victory Conditions Overview

### Progression Tree Victory Conditions

1. **Domination Victory** - Achieved through the **Military Progression Tree**: Territorial control via military force
2. **Cultural Victory** - Achieved through the **Cultural Progression Tree**: Overwhelming influence causing city defections  
3. **Economic Victory** - Achieved through the **Economic Progression Tree**: Control of >75% of global resources

### Technology Tree Victory Condition

4. **Scientific Victory** - Achieved through the **Unified Technology Tree**: Advancing far enough to reach breakthrough discoveries like Mars colonization, AI singularity, or other era-defining achievements. There is no separate "Science Tree"; all civilizations advance through the same Technology Tree, and Scientific Victory represents being first to reach the ultimate technological milestones.

### Special Victory Condition

5. **Diplomatic Victory** - Player consensus declaring a winner based on diplomatic prowess (not tree-based)
...
The unified Technology Tree operates in parallel with the three progression trees:

- **Technology Tree (Unified)**: ALL civilizations discover the same fundamental technologies - Fire, Agriculture, Metallurgy, Writing, Printing Press, Steam Power, Electricity, Computers, Nuclear Physics, Quantum Computing, etc. These are discoveries about how the world works.
- **Progression Trees (Civilization-Specific)**: Each civilization makes unique choices about how to APPLY those technologies toward military, cultural, or economic dominance.

**Example**: 
- Technology Tree unlocks "Metallurgy" (a discovery all civilizations can make)
- Military Tree: Choose to apply metallurgy for heavy cavalry armor, phalanx infantry weapons, or naval warfare rams
- Cultural Tree: Apply metallurgy to create prestigious bronze artwork and monuments
- Economic Tree: Apply metallurgy for trade goods, mining infrastructure, or currency minting

**Another Example**:
- Technology Tree unlocks "Printing Press" (universal technology)
- Military Tree: Use for military manuals and command coordination
- Cultural Tree: Choose to print religious texts (reformation path) or popular literature (entertainment path)
- Economic Tree: Use for commercial record-keeping and financial instruments

This separation means all civilizations have access to the same technologies, but they make strategic choices about how to apply that knowledge, creating diverse development paths.
...
Each progression tree and the unified Technology Tree require different resource types:

### Technology Points (for Technology Tree)
- Generated by: Universities, laboratories, research institutions, scholarly population
- Used for: Advancing on the unified Technology Tree (all civilizations)
...
- **Note**: Technology advancement is shared knowledge - all civilizations progress through the same tree

### Military Points (for Military Progression Tree)
- Generated by: Training facilities, barracks, war academies
- Used for: Military doctrine and unit specialization choices
- Costs: Military unit production, active warfare experience
- Boosted by: Population willing to serve, military traditions

### Culture Points (for Cultural Progression Tree)
...
### Economic Points (for Economic Progression Tree)
...
- **Technology Progress → Military Points**: Military technology applications (60% efficiency)
- **Culture Points → Economic Points**: Cultural tourism generates income (70% efficiency)

**Key Principle**: Direct generation is more efficient than conversion, but conversion provides flexibility. Technology Points advance the shared Technology Tree, while progression tree points represent civilization-specific strategic choices.
...
Technology Tree and Progression Trees require database tracking:

```javascript
{
  civilizationId: ObjectId,
  
  // Unified Technology Tree (shared across all civilizations)
  technologyTree: {
  ...
  // Civilization-specific Progression Trees
  progressionTrees: {
    military: {
      unlockedDevelopments: [String], // Military doctrines and specializations
...
The Victory Progression Trees system provides SimCiv with strategic depth by separating technological discovery from strategic application. All civilizations progress through the unified Technology Tree, but make unique choices about how to apply that knowledge through Military, Cultural, and Economic progression trees.

**Key Achievements of This Design**:

1. **Unified Technology Tree**: All civilizations discover the same technologies (Fire → Metallurgy → Electricity → Quantum Physics), but Scientific Victory goes to those who advance furthest
2. **Three Application Trees**: Military, Cultural, and Economic trees focus on HOW civilizations apply their technological knowledge
3. **Strategic Specialization**: Within each progression tree, players choose specific paths creating diverse strategies (e.g., naval vs. land military, religion vs. arts culture)
4. **Interconnected Systems**: Progression trees require technological advancement, creating balanced gameplay
5. **Clear Victory Conditions**: Four distinct victory paths (Domination, Scientific, Cultural, Economic) plus Diplomatic
6. **Historical Authenticity**: Separation of discovery from application reflects real civilization development
7. **Balanced Competition**: All victory paths are viable through different combinations of technology and progression choices

**Integration with Existing Systems**:
- Unifies the Technology Tree concept (0.0004_TECH_TREE.md to be extended through all eras)
- Removes redundant "Science Tree" by recognizing all technologies are scientific
...
1. Extend Technology Tree (0.0004_TECH_TREE.md) beyond prehistoric era through all historical eras
2. Define exact numerical values for all costs and effects in progression trees
3. Create detailed prerequisite dependency charts
